...
```bash
STACK_NAME=stag-hello-fastapi-com sh ./scripts/deploy.sh
```
...
```bash
docker node update --label-add stag-hello-fastapi-com.app-db-data=true cat.example.com
```
...
Frontend: https://stag.hello-fastapi.com

Backend: https://stag.hello-fastapi.com/api/

Automatic Interactive Docs (Swagger UI): https://stag.hello-fastapi.com/docs

Automatic Alternative Docs (ReDoc): https://stag.hello-fastapi.com/redoc

PGAdmin: https://pgadmin.stag.hello-fastapi.com

Flower: https://flower.stag.hello-fastapi.com
